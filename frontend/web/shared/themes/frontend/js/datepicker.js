class datePicker {
    ...
    _showCalendar(element, startDate){
        ...
        vm.renderCalendar(sinceDate, untilDate, element);
    ...
    renderCalendar(sinceDate, untilDate, element) {
        var vm = this;
untilDate = Fri Sep 16 2016 00:00:00 GMT+0200 (Egypt Standard Time);
            ...
            month.weeks.forEach(function(week){
                ...
                vm.weekDays.forEach(function(day){
                    if(typeof week[day] !== 'undefined'){
                        ...
                        if(week[day].date.getTime() >= sinceDate.getTime() && week[day].date.getTime() <= untilDate.getTime()){
                            td.className = 'active';
