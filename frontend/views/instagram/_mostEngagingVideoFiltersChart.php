...
if($most_engaging_video_filters_json_table){
    $this->registerJs("GoogleCharts.drawCircle(".$most_engaging_video_filters_json_table.", 'Most Engaging Video Filters', 'most_engaging_video_filters')", yii\web\View::POS_END);
?>
