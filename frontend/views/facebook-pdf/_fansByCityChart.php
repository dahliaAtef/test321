...
echo '<h3 class="internal-title noneBG" style="text-align:center; color: #6d6e71;">Distribution of fans by City</h3>';
		...
		if($fans_city_json_table){
		    $this->registerJs("GoogleCharts.drawCircle(".$fans_city_json_table.", 'fb', 'fans_city')", yii\web\View::POS_END); 
                    echo '<div id="fans_city"><img src="'.$fans_city_img.'"></div>';
		}else{
