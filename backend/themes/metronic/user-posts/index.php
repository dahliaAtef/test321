...
/* @var $searchModel common\models\custom\search\UserPosts */
...
<div class="page-content user-posts-index">
        ...
        <div class="page-toolbar">
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <?= Html::a('Create User Posts', ['create'], ['class' => '']) ?>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-cascade">
                <div class="portlet-title">
                    ...
                    <div class="tools">
                        <!--<a href="javascript:;" class="reload" onclick="$.pjax.reload({container: #pjaxUserPostsGrid});"></a>-->
                            ...
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <?=  Html::a('Add New <i class="fa fa-plus"></i>', ['create'], ['class' => 'btn green']) ?> 
                                            ...
                                            <?php Pjax::begin(['id' => 'pjaxUserPostsGrid']); ?>
